...
enum smt2_symbol {
  ...
  SMT2_SYM_ROUNDINGMODE,
  SMT2_SYM_FLOAT32,
  SMT2_SYM_FLOAT64,
  SMT2_SYM_FLOATINGPOINT,
  SMT2_SYM_RNE,
  SMT2_SYM_RNA,
  SMT2_SYM_RTN,
  SMT2_SYM_RTP,
  SMT2_SYM_RTZ,
  SMT2_SYM_ROUND_NEAREST_TIES_TO_EVEN,
  SMT2_SYM_ROUND_NEAREST_TIES_TO_AWAY,
  SMT2_SYM_ROUND_TOWARD_NEGATIVE,
  SMT2_SYM_ROUND_TOWARD_POSITIVE,
  SMT2_SYM_ROUND_TOWARD_ZERO,
  SMT2_SYM_FP_NAN,
  SMT2_SYM_FP_POS_INF,
  SMT2_SYM_FP_NEG_INF,
  SMT2_SYM_FP_POS_ZERO,
  SMT2_SYM_FP_NEG_ZERO,
  SMT2_SYM_FP,
  SMT2_SYM_FP_ADD,
  SMT2_SYM_FP_SUB,
  SMT2_SYM_FP_MUL,
  ...
  SMT2_SYM_FP_ISINF,
  SMT2_SYM_FP_ISZERO,
  SMT2_SYM_FP_ISSUBNORMAL,
  SMT2_SYM_FP_ISNORMAL,
